...
#
# Differences from v15.4.1:
# - Does not keep (in RAM) nor saves SVM models.
# - Does not use "perf"(ormance) of a model, just train and test 
#   correlations for ranking them.
#
...
.lagmgr.internal.version <- "15.5.6"
